...
//		});
		...
		$("#side-menu").metisMenu(), $(".sidebar-container").slimScroll({
			height: "100%",
			railOpacity: .4,
			wheelStep: 10
		...
		if ($("#fixednavbar").click(function() {
				...
				return $("body").removeClass("skin-1"), $("body").removeClass("skin-2"), $("body").removeClass("skin-3"), $('#right-sidebar').toggleClass('sidebar-open'), localStorage.setItem("skin", "skin")
			}), $(".s-skin-1").click(function() {
				return $("body").removeClass("skin-2"), $("body").removeClass("skin-3"), $("body").addClass("skin-1"), $('#right-sidebar').toggleClass('sidebar-open'), localStorage.setItem("skin", "skin-1")
			}), $(".s-skin-3").click(function() {
				return $("body").removeClass("skin-1"), $("body").removeClass("skin-2"), $("body").addClass("skin-3"), $('#right-sidebar').toggleClass('sidebar-open'), localStorage.setItem("skin", "skin-3")
			}), localStorageSupport) {
